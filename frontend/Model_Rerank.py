...
def change_use_reranker():
    st.session_state["current_llm_settings"]["use_reranker"] = st.session_state[
        "use_reranker"
    ]
    CONFIG_STORE.put(
...
def change_reranker_model():
    st.session_state["current_llm_settings"]["reranker_model"] = st.session_state[
...
with reranking_settings:
    ...
    if st.session_state["current_llm_settings"]["use_reranker"] == True:
        ...
        reranker_model = st.selectbox(
            ...
            index=reranker_model_list.index(
                st.session_state["current_llm_settings"]["reranker_model"]
            ),
